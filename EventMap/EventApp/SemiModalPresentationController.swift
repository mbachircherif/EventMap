...
class SemiModalView: UIPresentationController, DetailPlaceViewControllerDelegate {
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        let kBarHeight : CGFloat = 49
        return CGRect(x: 0 , y: containerView!.bounds.height - (containerView!.bounds.height / 2 ) - (kBarHeight + 15) , width: containerView!.bounds.width, height: containerView!.bounds.height / 1.9)
    }
