...
class RouteModalTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    
    var type: routeModalTransitionAnimatorType
    
    init(type:routeModalTransitionAnimatorType) {
        self.type = type
    }
...
internal enum routeModalTransitionAnimatorType {
    case Present
    case Dismiss
}
